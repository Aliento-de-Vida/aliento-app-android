...
class PreferencesImpl(
    ...
    override var isDarkThemeFlow: Flow<Boolean> =
        preferencesStore.data.map { it[DARK_THEME] ?: false }
    ...
    override var pushEnabledFlow: Flow<Boolean> =
        preferencesStore.data.map { it[PUSH_NOTIFICATIONS] ?: false }
