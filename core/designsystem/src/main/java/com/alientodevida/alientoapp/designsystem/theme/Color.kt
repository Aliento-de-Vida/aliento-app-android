...
fun colors(
    ...
    val colorPrimaryVariant =
        color(R.attr.colorPrimaryVariant, value, primaryVariant, primaryVariantFallback)
    ...
    val colorSecondaryVariant =
        color(R.attr.colorSecondaryVariant, value, secondaryVariant, secondaryVariantFallback)
    ...
    val colorOnBackground =
        color(R.attr.colorOnBackground, value, onBackground, onBackgroundFallback)

    val colorError = color(R.attr.colorError, value, error, errorFallback)
