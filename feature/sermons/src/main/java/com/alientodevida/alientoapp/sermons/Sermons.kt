...
import com.alientodevida.alientoapp.ui.components.Caption
import com.alientodevida.alientoapp.ui.components.ClickableIcon
import com.alientodevida.alientoapp.sermons.navigation.BottomNavItem
import com.alientodevida.alientoapp.sermons.navigation.NavigationGraph
  ...
  androidx.compose.material.BottomNavigation(
    ...
    items.forEach { item ->
      ...
      BottomNavigationItem(
        ...
        label = { Caption(
          text = item.title,
          color = if (isSelected) MaterialTheme.colors.onSurface else MaterialTheme.colors.onSurface.copy(0.4f),
        ) },
