...
import com.alientodevida.alientoapp.domain.campus.CampusRequest
...
class CampusRepositoryImpl(
  ...
  override suspend fun editCampus(campusRequest: CampusRequest): Campus {
    val campusCoverName = if (campusRequest.attachment != null) "campus_cover".addTimeStamp() else campusRequest.imageName
